...
<Global.System.Serializable(),  _
 ...
 Global.System.Xml.Serialization.XmlRootAttribute("Database3DataSet1"),  _
 Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")>  _
Partial Public Class Database3DataSet1
    ...
    Public Overrides Function Clone() As Global.System.Data.DataSet
        Dim cln As Database3DataSet1 = CType(MyBase.Clone,Database3DataSet1)
        cln.InitVars
    ...
    Private Sub InitClass()
        Me.DataSetName = "Database3DataSet1"
        Me.Prefix = ""
    ...
    Public Shared Function GetTypedDataSetSchema(ByVal xs As Global.System.Xml.Schema.XmlSchemaSet) As Global.System.Xml.Schema.XmlSchemaComplexType
        Dim ds As Database3DataSet1 = New Database3DataSet1()
    ...
    Partial Public Class Table3DataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overloads Function AddTable3Row(ByVal FName As String, ByVal LName As String, ByVal Phone As Integer, ByVal Address As String, ByVal District As String, ByVal Payment As String, ByVal Card As Integer, ByVal Price As Integer, ByVal Process As String, ByVal Details As String) As Table3Row
            Dim rowTable3Row As Table3Row = CType(Me.NewRow,Table3Row)
            Dim columnValuesArray() As Object = New Object() {Nothing, FName, LName, Phone, Address, District, Payment, Card, Price, Process, Details}
...
Namespace Database3DataSet1TableAdapters
    ...
    Partial Public Class Table3TableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM `Table3` WHERE ((`ID` = ?) AND ((? = 1 AND `FName` IS NULL) OR (`FNam"& _ 
                ...
                ")) AND ((? = 1 AND `Process` IS NULL) OR (`Process` = ?)))"
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO `Table3` (`FName`, `LName`, `Phone`, `Address`, `District`, `Payment`"& _ 
                ", `Card`, `Price`, `Process`, `Details`) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE `Table3` SET `FName` = ?, `LName` = ?, `Phone` = ?, `Address` = ?, `Distri"& _ 
                "ct` = ?, `Payment` = ?, `Card` = ?, `Price` = ?, `Process` = ?, `Details` = ? WH"& _ 
                "ERE ((`ID` = ?) AND ((? = 1 AND `FName` IS NULL) OR (`FName` = ?)) AND ((? = 1 A"& _ 
                "ND `LName` IS NULL) OR (`LName` = ?)) AND ((? = 1 AND `Phone` IS NULL) OR (`Phon"& _ 
                "e` = ?)) AND ((? = 1 AND `District` IS NULL) OR (`District` = ?)) AND ((? = 1 AN"& _ 
                "D `Payment` IS NULL) OR (`Payment` = ?)) AND ((? = 1 AND `Card` IS NULL) OR (`Ca"& _ 
                "rd` = ?)) AND ((? = 1 AND `Price` IS NULL) OR (`Price` = ?)) AND ((? = 1 AND `Pr"& _ 
                "ocess` IS NULL) OR (`Process` = ?)))"
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As Database3DataSet1.Table3DataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As Database3DataSet1.Table3DataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As Database3DataSet1.Table3DataTable = New Database3DataSet1.Table3DataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As Database3DataSet1.Table3DataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As Database3DataSet1) As Integer
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID As Integer, ByVal Original_FName As String, ByVal Original_LName As String, ByVal Original_Phone As Global.System.Nullable(Of Integer), ByVal Original_District As String, ByVal Original_Payment As String, ByVal Original_Card As Global.System.Nullable(Of Integer), ByVal Original_Price As Global.System.Nullable(Of Integer), ByVal Original_Process As String) As Integer
        ...
        Public Overloads Overridable Function Update( _
                    ...
                    ByVal Original_Process As String) As Integer
            If (FName Is Nothing) Then
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(20).Value = CType(Original_Payment,String)
            End If
            If (Original_Card.HasValue = true) Then
                Me.Adapter.UpdateCommand.Parameters(21).Value = CType(0,Object)
                Me.Adapter.UpdateCommand.Parameters(22).Value = CType(Original_Card.Value,Integer)
            Else
            ...
            If (Original_Price.HasValue = true) Then
                ...
                Me.Adapter.UpdateCommand.Parameters(24).Value = CType(Original_Price.Value,Integer)
            Else
            ...
            Else
                ...
                Me.Adapter.UpdateCommand.Parameters(26).Value = CType(Original_Process,String)
            End If
    ...
    Partial Public Class TableAdapterManager
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateUpdatedRows(ByVal dataSet As Database3DataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow), ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateInsertedRows(ByVal dataSet As Database3DataSet1, ByVal allAddedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._table3TableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Private Function UpdateDeletedRows(ByVal dataSet As Database3DataSet1, ByVal allChangedRows As Global.System.Collections.Generic.List(Of Global.System.Data.DataRow)) As Integer
            Dim result As Integer = 0
            If (Not (Me._table3TableAdapter) Is Nothing) Then
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")>  _
        Public Overridable Function UpdateAll(ByVal dataSet As Database3DataSet1) As Integer
